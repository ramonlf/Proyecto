                            ...
                            <form action="Login" method="POST">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <input type="submit" name="enviar" class="form-control btn" id="enviar" value="Iniciar sesion" />
                                    </div>
                                    <div class="form-group col-md-6">
                                        <input type="reset" name="reset" class="form-control btn" id="reset" value="Limpiar campos" />
                                    </div>
                                </div>
                            </form>
                        </div>
